(defproject bass4 "4.6-SNAPSHOT"
  ...
  :dependencies [
                 ...
                 [org.clojure/tools.logging "0.6.0"]        ; https://github.com/clojure/tools.logging
                 ...
                 [prismatic/schema "1.1.12"]                ; https://github.com/plumatic/schema
  ...
  {:uberjar       {:omit-source    true
   ...
   :project/dev   {:dependencies   [[ring/ring-devel "1.8.0"] ; Used for reloading namespaces before web requests
                                    ...
                                    [philoskim/debux "0.6.3"] ; https://github.com/philoskim/debux
